...
' ===============================================
Function CalcularMediaMensal(nomePessoa, totalGeral)
    Dim mediaMensal, numMesesComVenda
    
    mediaMensal = 0
    numMesesComVenda = 0
    
    If mesesComVenda.Exists(nomePessoa) Then
        Set infoMeses = mesesComVenda(nomePessoa)
        numMesesComVenda = infoMeses.Count
    End If
    
    ' Se vendeu em pelo menos 1 mês, calcular média
    If numMesesComVenda > 0 Then
        mediaMensal = totalGeral / numMesesComVenda
    End If
                    ...
                    <tbody>
                        ...
                        If dadosPessoas.Count > 0 Then
                            ...
                            For Each pessoaKey In arrPessoas
                                ...
                                ' CALCULAR MÉDIA MENSAL (NOVA LÓGICA)
                                mediaMensalPessoa = CalcularMediaMensal(pessoaKey, infoPessoa("TotalGeral"))
                    ...
                    <tfoot>
                        <tr class="total-geral">
                            ...
                            <td class="text-right-v">
                                ...
                                Dim mediaGeralMensal, somaMediasMensais, countPessoasComVenda
                                somaMediasMensais = 0
                                countPessoasComVenda = 0
                                
                                For Each pessoaKey In arrPessoas
                                    Set infoPessoa = dadosPessoas(pessoaKey)
                                    Dim mediaPessoa
                                    mediaPessoa = CalcularMediaMensal(pessoaKey, infoPessoa("TotalGeral"))
                                    If mediaPessoa > 0 Then
                                        somaMediasMensais = somaMediasMensais + mediaPessoa
                                        countPessoasComVenda = countPessoasComVenda + 1
                                    End If
                                Next
                                
                                If countPessoasComVenda > 0 Then
                                    mediaGeralMensal = somaMediasMensais / countPessoasComVenda
                                    Response.Write FormatNumber(mediaGeralMensal, 2)
                                Else
                                    Response.Write "0,00"
                                End If
                                %>
