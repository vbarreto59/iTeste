...
<div class="container-fluid">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header text-white" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%);">
                            <h5 class="mb-0"><i class="fas fa-exclamation-triangle"></i> Top 5 Piores Gerências vs Meta</h5>
                        </div>
                        <div class="card-body">
                            <% 
                            ' =======================================================
                                ...
                                <table class="vgv-table">
                                    ...
                                    <tbody>
                                        ...
                                        For i = 0 To showWorstCount - 1
                                            ...
                                            Dim worstGerNome, worstGerVGV, worstGerPercent, worstGerClass
                                            ...
                                            If gerTotalVGV > 0 Then
                                                worstProgressWidth = (worstGerVGV / gerTotalVGV) * 100
                                            Else
                                        ...
                                        <tr style="background-color: #f8d7da; font-weight: bold;">
                                            <td colspan="2">MÉDIA DAS 5 PIORES</td>
                                            <td style="text-align: right;">
                            ...
                            <div class="alert alert-danger mt-3 p-2" role="alert">
                                <div class="d-flex align-items-center">
                                    ...
                                    <small><strong>Atenção:</strong> Estas são as 5 gerências com menor % de atingimento da meta.</small>
                                </div>
                            </div>
   ...
   <!-- ##############NOVA SEÇÃO: TOP 5 EMPRESAS (se existir campo Empresa) -->
