...
If mesFiltro <> "" Then
    ...
    ' CORREÇÃO: Verificar se arrMesesNome foi inicializado
    If IsArray(arrMesesNome) Then
        metaSubtitulo = arrMesesNome(CInt(mesFiltro)) & "/" & anoFiltro
    Else
        metaSubtitulo = "Mês " & mesFiltro & "/" & anoFiltro
    End If
ElseIf anoFiltro <> "" Then
    metaTitulo = "Meta do Ano"
...
' Inicializar array de meses (corrigir ordem)
Dim arrMesesNome(12)
...
<head>
    ...
    <style>
        ...
        .bg-pink {
            background: linear-gradient(135deg, #ff4d8d 0%, #ff6b9d 100%) !important;
        }
        .badge {
            font-weight: 600;
            padding: 5px 10px;
        ...
        /* NOVO ESTILO PARA CARDS REDUZIDOS */
        .metric-card-small {
            text-align: center;
        ...
        /* Container para os 3 cards superiores */
        .top-metrics-row {
            display: grid;
            grid-template-columns: 1fr 1fr 1.5fr; /* Terceiro card maior */
            gap: 15px;
            margin-bottom: 25px;
        }
...
<div class="container-fluid">
    ...
    <div class="main-container">
        ...
        <div class="content-center">
            <!-- NOVOS CARDS DE MÉTRICAS - LAYOUT DE 3 COLUNAS -->
            ...
            <div class="top-metrics-row">
                ...
                <div class="card bg-purple text-white">
                    <div class="card-body metric-card-small">
                        ...
                        <div class="metric-value-small">R$ <%=FormatNumber(TotalVendas, 2)%></div>
                        <p class="metric-label">VGV</p>
                    </div>
                </div>


                <!-- Ticket Médio (Card Reduzido) -->
                <div class="card bg-purple text-white">
                    <div class="card-body metric-card-small">
                        <i class="fas fa-ticket-alt fa-2x mb-2"></i>
                ...
                <!-- Unidades Vendidas (Card Reduzido) -->
                ...
                <div class="card bg-pink text-white">
                    <div class="card-body metric-card-normal">
                        <i class="fas fa-bullseye fa-3x mb-2"></i>
                        <h5 class="metric-label"><%=metaTitulo%></h5>
