...
AssuntoEmail = "Lista de Usuarios PWR-" & UCase(GroupToFilter) & " - " & Date() & " - " & Time()
...
strSQL = "SELECT Usuarios.Usuario, Usuarios.Ativo, Usuarios.SenhaAtual, Grupo.Nome_Grupo, Usuarios.Email, Usuarios.Telefones " & _
...
strTextBody = strTextBody & "----------------------------------------" & vbCrLf & _
                                   ...
                                   "PWR: " & rsUsers("SenhaAtual") & vbCrLf & _ 
