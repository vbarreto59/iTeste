    ...
    <% Else %>
        ...
        If isConnUsuariosOk Then
            ...
            If isConnSalesOk Then 
                ...
                ' CONSULTA MODIFICADA: Incluindo o campo Ativo
                Dim sql_corretores_sem_vendas
                sql_corretores_sem_vendas = "SELECT nome, Gerencia, Ativo FROM usuarios " & _
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        Do While Not rs.EOF
                                            ...
                                            If currentGerencia <> rs("Gerencia") Then
                                                ...
                                                If Not firstGerencia Then
                                                    ...
                                                    <tr class="gerencia-total">
                                                        <td class="text-right" colspan="2"><strong>Total da Gerência:</strong></td>
                                            ...
                                            ' Determina o status do corretor (Ativo/Inativo)
                                            Dim badgeClass, statusText, ativoValue
                                            ativoValue = rs("Ativo")
                                            
                                            ' Verifica o valor do campo Ativo (tratando diferentes formatos possíveis)
                                            If IsNull(ativoValue) Then
                                                badgeClass = "badge-secondary"
                                                statusText = "N/A"
                                            ElseIf TypeName(ativoValue) = "Boolean" Then
                                                If ativoValue = True Then
                                                ...
                                                Else
                                                    ...
                                                    statusText = "Inativo"
                                                End If
                                            ElseIf IsNumeric(ativoValue) Then
                                                If CInt(ativoValue) = 1 Or ativoValue = "1" Then
                                                    badgeClass = "badge-success"
                                                    statusText = "Ativo"
                                                Else
                                                    badgeClass = "badge-danger"
                                                    statusText = "Inativo"
                                                End If
                                            ElseIf TypeName(ativoValue) = "String" Then
                                                If UCase(ativoValue) = "TRUE" Or UCase(ativoValue) = "SIM" Or ativoValue = "1" Then
                                                    badgeClass = "badge-success"
                                                    statusText = "Ativo"
                                                ElseIf UCase(ativoValue) = "FALSE" Or UCase(ativoValue) = "NÃO" Or UCase(ativoValue) = "NAO" Or ativoValue = "0" Then
                                                    badgeClass = "badge-danger"
                                                    statusText = "Inativo"
                                                Else
                                                    badgeClass = "badge-secondary"
                                                    statusText = ativoValue
                                                End If
                                            Else
                                                badgeClass = "badge-secondary"
