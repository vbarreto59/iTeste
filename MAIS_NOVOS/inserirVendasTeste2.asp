...
FlushLine "<strong>Iniciando geração de massa para 2026…</strong>"
FlushLine "Empreendimentos: " & (maxEmp + 1) & " | Diretorias: " & (maxDir + 1) & " | Corretores: " & (maxCor + 1)

Dim anoAlvo: anoAlvo = 2026
...
For mes = 1 To 12
    ...
    For k = 1 To qtdPorMes
        ...
        sqlVendas = "INSERT INTO Vendas (" & _
                    ...
                    SqlQuote("Massa 2026 - auto") & ", " & SqlQuote(usuarioAtual) & ", " & idDir & ", " & SqlQuote(nomeDir) & ", " & _
