...
If filtroAno <> "" Then
        ...
        If Not rsDadosMensais.EOF Then
            ...
            Do While Not rsDadosMensais.EOF
                ...
                If Not IsNull(rsDadosMensais("TotalVGV")) Then
                    totalVGV = (rsDadosMensais("TotalVGV"))
    ...
    If dadosCorretor.Count > 0 Then
            ...
            If Not rsEmpreendVendas.EOF Then
                Do While Not rsEmpreendVendas.EOF
                    ...
                    If Not IsNull(rsEmpreendVendas("TotalVGV")) Then
                        totalVGVEmp = CDbl(rsEmpreendVendas("TotalVGV"))
                    End If
                    
                    If Not IsNull(rsEmpreendVendas("MenorVGV")) Then
                        menorVGVEmp = CDbl(rsEmpreendVendas("MenorVGV"))
                    End If
                    
                    If Not IsNull(rsEmpreendVendas("MaiorVGV")) Then
                        maiorVGVEmp = CDbl(rsEmpreendVendas("MaiorVGV"))
                    End If
                    
                    If Not IsNull(rsEmpreendVendas("MediaVGV")) Then
                        mediaVGVEmp = CDbl(rsEmpreendVendas("MediaVGV"))
                    End If
        ...
        ' ===============================================
        ' 3. OBTER LOCALIDADES PARA OUTRAS ABAS
        ' ===============================================
...
<body>
    <div class="container-fluid">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <!-- Tab 2: Vendas por Mês (valores e quantidades) -->
                                ...
                                <tbody>
                                    ...
                                    If Not vendasPorMesDetalhado Is Nothing And vendasPorMesDetalhado.Count > 0 Then
                                        ...
                                        For Each mesNum In arrMesesDetalhados
                                            Dim dadosMesDetalhado, mediaVendaMes, percentualMes
                                            dadosMesDetalhado = vendasPorMesDetalhado(mesNum)
                                            
                                            If dadosMesDetalhado(1) > 0 Then
                                                mediaVendaMes = dadosMesDetalhado(0) / dadosMesDetalhado(1)
                                            Else
                                                mediaVendaMes = 0
                                            End If
                                            
                                            If totalGeralVGV > 0 Then
                                                percentualMes = (dadosMesDetalhado(0) / totalGeralVGV) * 100
                                            Else
                                                percentualMes = 0
                                            End If
                                    %>
                                    <tr>
                                        ...
                                        <td class="text-center"><%= dadosMesDetalhado(1) %></td>
                                        <td class="text-end"><strong><%= FormatNumber(dadosMesDetalhado(0), 2) %></strong></td>
                                        <td class="text-end"><%= FormatNumber(dadosMesDetalhado(2), 2) %></td>
                            ...
                            <div class="card-body">
                                ...
                                If Not vendasPorMesDetalhado Is Nothing And vendasPorMesDetalhado.Count > 0 Then
                                    ...
                                    For Each mesNum In vendasPorMesDetalhado.Keys
                                        ...
                                        If dadosMesTemp(0) > melhorValor Then
                                            melhorValor = dadosMesTemp(0)
                                            melhorMes = mesNum
                                        End If
                                    Next
                                    If melhorMes <> "" Then
                                        Response.Write arrMesesNome(CInt(melhorMes)) & " - R$ " & FormatNumber(melhorValor, 2)
                                    End If
                                End If
                                %>
                                </p>
            ...
            <!-- Tab 4: Empreendimentos (MODIFICADO - REMOVIDAS COLUNAS "Corretores Atuantes" e "Localidades") -->
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-primary" data-bs-toggle="tooltip"
                                                  title="<% 
                                                  Dim arrEmpreendLocal
                                                  arrEmpreendLocal = infoVendasLocal("Empreendimentos").Keys
                                                  For Each empLocal In arrEmpreendLocal
                                                      Response.Write empLocal & ", "
                                                  Next
                                                  %>">
                                                <%= infoVendasLocal("Empreendimentos").Count %>
                                            </span>
                                        </td>
                                    </tr>
                                    <%
                                    ...
                                    <div class="card-body">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item">
                                                ...
                                                <small>Empreendimentos: <%= infoLocalTop("Empreendimentos").Count %></small>
                                            </div>
                                            <%
    ...
    function renderizarGraficos() {
        ...
        // NOVO: Gráfico de Empreendimentos
