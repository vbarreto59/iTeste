   ...
   <script>
    ...
    $(document).ready(function() {
        ...
        $('#viewPaymentsModal').on('show.bs.modal', function(event) {
            ...
            $('#paymentsTableBody').html('<tr><td colspan="7" class="text-center"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Carregando...</span></div></td></tr>');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success && response.data && response.data.length > 0) {
                        ...
                        response.data.forEach(function(payment, index) {
                            // Log para depuração de cada pagamento
                            ...
                            html += `
                                <tr>
                                    ...
                                    <td class="text-end">R$ ${formatCurrency(valorPago)}</td>
                ...
                error: function(xhr, status, error) {
                    console.error('Erro na requisição AJAX para ID_Venda=' + idVenda + ':', {
                        status: status,
                        error: error,
